...
// WE ARE STORING ALL OF THE H4 ELEMENTS IN THIS VARIABLE
...
//USING THIS TO LOOP THROUGH ALL H4 ELEMENTS TO ADD STYLING
for (var i = 0; i< siteTitles.length; i++) {
    siteTitles[i].setAttribute("style", "color: blue", "font-size: 30px", "font-weight: bold", "margin: 0", "padding-left: 10px")
}